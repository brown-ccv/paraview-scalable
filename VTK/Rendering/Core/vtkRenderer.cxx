...
#ifdef USE_SCALABLE
void vtkRenderer::ActivateScalable()
{
	this->ScalableActivated = true;
}

void vtkRenderer::InitializeScalable()
{
	this->ScalableInitialized = true;
}

bool vtkRenderer::IsScalableActivated()
{
	return this->ScalableActivated;
}

bool vtkRenderer::IsScalableInitialized()
{
	return this->ScalableInitialized;
}
#endif
