...
#ifdef USE_SCALABLE
void vtkOpenGLRenderWindow::SetScalableLeftBackBufferMesh(EasyBlendSDK_Mesh* mesh)
{
	this->gmSDKL=mesh;
}

void vtkOpenGLRenderWindow::SetScalableRightBackBufferMesh(EasyBlendSDK_Mesh* mesh)
{
	this->gmSDKR=mesh;
}

EasyBlendSDK_Mesh* vtkOpenGLRenderWindow::GetScalableLeftBackBufferMesh()
{
	return this->gmSDKL;
}

EasyBlendSDK_Mesh* vtkOpenGLRenderWindow::GetScalableRightBackBufferMesh()
{
	return this->gmSDKR;
}
#endif
