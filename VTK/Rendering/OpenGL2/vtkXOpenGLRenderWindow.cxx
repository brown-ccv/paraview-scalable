...
void vtkXOpenGLRenderWindow::Frame()
{
  ...
  #ifdef USE_SCALABLE
       if(this->GetScalableLeftBackBufferMesh() != NULL)
       {
         glFinish();
         EasyBlendSDK_TransformInputToOutput(this->GetScalableLeftBackBufferMesh());	
       }
       if(this->GetScalableRightBackBufferMesh() != NULL)
       {
         glFinish();
         EasyBlendSDK_TransformInputToOutput(this->GetScalableRightBackBufferMesh());
...
void vtkXOpenGLRenderWindow::CreateAWindow()
{
  ...
  if (this->Internal->FBConfig)
  {
    std::cout << "CREATING OPENGL CONTEXT 1 \n" ;
    ...
    {
       std::cout << "CREATING OPENGL CONTEXT 1.2 \n" ;
      ...
      bool done = false;
     std::cout << "CREATING OPENGL CONTEXT 2\n" ;
      while (!done)
      {
    ...
    std::cout << "CREATING OPENGL CONTEXT 3\n" ;
  }
