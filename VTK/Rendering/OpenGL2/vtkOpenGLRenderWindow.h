...
public:
  ...
  #ifdef USE_SCALABLE
    void SetScalableLeftBackBufferMesh(EasyBlendSDK_Mesh* mesh);
    void SetScalableRightBackBufferMesh(EasyBlendSDK_Mesh* mesh);
    EasyBlendSDK_Mesh* GetScalableLeftBackBufferMesh();
    EasyBlendSDK_Mesh* GetScalableRightBackBufferMesh();
  #endif
